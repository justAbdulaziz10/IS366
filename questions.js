...
// ----- Added after full source audit -----
{ id:"dss_add1", topic:"DSS & Analytics", type:"mc",
  q:"All of the following have contributed to the growth of decision support systems EXCEPT:",
  options:["Group communication and collaboration","Improved data management","Anywhere, anytime support","Increasing costs of computer hardware"], answer:3,
  exp:"Hardware costs have DECREASED, which helped DSS grow. The decreasing (not increasing) cost of computers/hardware is a driver — so 'increasing costs of computer hardware' is the exception."},
{ id:"dss_add2", topic:"DSS & Analytics", type:"mc",
  q:"Which of the following has contributed to the growth of decision support systems?",
  options:["Group communication and collaboration","Improved data management","Anywhere, anytime support","All of the above"], answer:3,
  exp:"Group communication/collaboration, improved data management, and anywhere/anytime support all contributed to DSS growth. (The decreasing cost of hardware also helped — note it's the DECREASE, not increase.)"},


{ id:"dss_add3", topic:"DSS & Analytics", type:"mc",
  q:"Business Intelligence relies the most on which type of system?",
  options:["Expert System","Data Warehousing","Enterprise Resource Planning (ERP)","Executive Information Systems"], answer:1,
  exp:"Business Intelligence relies the most on Data Warehousing (the foundation of BI architecture)."},
{ id:"dss_add4", topic:"DSS & Analytics", type:"mc",
  q:"What is the first step in the decision-making process?",
  options:["Knowing what data is available","Knowing the potential users of the solution","Understanding the problem we are trying to solve","Determining the best tools for solving the problem"], answer:2,
  exp:"The first step is understanding/recognizing the problem we are trying to solve (the Intelligence phase). You define the problem before designing or choosing solutions."},
{ id:"ai_add1", topic:"AI Concepts", type:"mc",
  q:"A well-known and leading company in the market started losing market-share and facing losses in revenues. Which of the following is the MOST likely reason?",
  options:["It did not keep up with the changing market conditions","It replaced its long-term CEO with a new CEO","It conducted a large system update","It decided to start using AI to replace some experienced employees"], answer:0,
  exp:"The most likely reason a leading company loses market share is failing to keep up with changing market conditions (the driver behind needing better decision support / analytics)."},
{ id:"dm_add1", topic:"Data Mining", type:"mc",
  q:"As per the course textbook, which of the following is NOT one of the main disciplines related to data mining?",
  options:["Statistics","Mathematics","Management science","Data warehousing"], answer:3,
  exp:"Data mining blends statistics, mathematics, AI/machine learning, and management science. Data warehousing is a data SOURCE/storage technology, not one of the core disciplines that data mining is built from."},
{ id:"dss_add5", topic:"DSS & Analytics", type:"tf",
  q:"Verification and testing of the proposed solution is an activity that may come after the Choice Stage of Simon's Decision-Making Process.",
  answer:true,
  exp:"TRUE. Verification and testing of the proposed solution follows the Choice stage (before Implementation). Note: a different exam version phrases it as 'after the Design Stage' — match the exact wording on your paper."},
{ id:"dss_add6", topic:"DSS & Analytics", type:"tf",
  q:"Verification and testing of the proposed solution is an activity that may come after the Design Stage of Simon's Decision-Making Process.",
  answer:true,
  exp:"TRUE per the IS 366 quiz key (Version 2). Verification/testing can be described as following the Design stage on the path Intelligence → Design → Choice → Implementation. Read your version's wording carefully — the other version says 'after the Choice Stage'."},
